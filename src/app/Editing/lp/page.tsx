...
import {
  fadeIn, fadeLeft, fadeRight, motionViewport, scaleIn, staggerContainer, staggerItem,
} from "@/lib/motion";
...
import {
  FaCheck, FaChevronDown, FaCircleCheck, FaClipboardList, FaEnvelope, FaFacebookF, FaHatWizard, FaHeart, FaInstagram, FaLandmark, FaLayerGroup, FaLightbulb, FaLinkedinIn, FaLocationDot, FaMagnifyingGlass, FaPhone, FaRocket, FaUserPen, FaUserSecret, FaXmark,
...
const PRIMARY_SOFT = "#D8F3DC";
const PRIMARY_TINT = "#F1FAF3";
const SECONDARY = "#081C15";
const ON_PRIMARY = "#FFFFFF";
const ON_SOFT = "#111111";
const DELETE_RED = "#C62828";
...
const GENRE_OPTIONS = [
  "Fiction", "Non-Fiction", "Romance", "Children's Book", "Memoir", "Business", "Poetry", "Other",
];
...
const BETTER_CHECKS = [
  "Basic editing", "Line by line editing", "Developmental editing", "Premium editing",
];
...
const EDITING_STAGES = [
  {
    title: "Manuscript Style Setup", body: "Before a single sentence changes, we lock in your style guide, spelling convention, and a glossary of names and invented terms so every chapter stays consistent.", sample: [
      [
        { text: "Citation & spacing pass", kind: "note" }, { text: " " }, ], [
        { text: "a", kind: "del" }, { text: "A striking resemblance has been seen between the success rates of the Netherlands and that of" }, { text: "ofthe", kind: "del" }, { text: "of the", kind: "ins" }, { text: " US. In the study by" }, { text: "byMartynova", kind: "del" }, { text: "Martynova", kind: "ins" }, { text: " and Renneboog (2010)" }, { text: "it", kind: "del" }, { text: " it", kind: "ins" }, { text: " " }, { text: "already became clear found", kind: "del" }, { text: "found", kind: "ins" }, { text: " that shareholder protection was almost equal between the US and the" }, { text: "Netherlandsin", kind: "del" }, { text: "Netherlands in", kind: "ins" }, { text: " both countries." }, ], ] as EditSegment[][], }, {
    title: "Line & Copy Editing", body: "Sentence-level work on clarity, rhythm, and word choice, paired with a strict pass on grammar, punctuation, tense, and continuity.", sample: [
      [
        { text: "This " }, { text: "corresponded", kind: "del" }, { text: "corresponds", kind: "ins" }, { text: " to the fact that " }, { text: "they both have a success rate is of approximately the 40%", kind: "del" }, { text: "both countries have a success rate of approximately 40%", kind: "ins" }, { text: "." }, ], [
        { text: "At least one", kind: "del" }, { text: "More than 1", kind: "ins" }, { text: " hedge fund acquired a share in " }, { text: "14the company in fourteen", kind: "del" }, { text: "fourteen", kind: "ins" }, { text: " of the 36 listed companies in my database. Of these, 10" }, { text: " of those", kind: "del" }, { text: " were working together to achieve certain goals." }, ], [
        { text: "The ", kind: "ins" }, { text: "The hedge funds held a share in the company for an average length of ", kind: "del" }, { text: "average length of hedge funds holding a share in the company is 531 days. Although Brav et al. (2008) " }, { text: "considered", kind: "del" }, { text: "may find", kind: "ins" }, { text: " this long-term period, I consider 531 days" }, { text: " is still to be seen as to be", kind: "del" }, { text: " to be", kind: "ins" }, { text: " short-term." }, ], ] as EditSegment[][], }, {
    title: "Precision Proofreading", body: "The final sweep catches typos, double spaces, broken hyphenation, stray formatting, and layout slips so your book goes to print clean.", sample: [
      [
        { text: "The average percentage of voting power " }, { text: "is initial", kind: "del" }, { text: "initially", kind: "ins" }, { text: " ranges between 8.06% and the maximum voting power is 10.10%." }, ], [
        { text: "From ", kind: "del" }, { text: "By", kind: "ins" }, { text: " looking at this data, it can be concluded that hedge funds are not generally involved in acquiring controlling blocks of stock." }, ], ] as EditSegment[][], }, {
    title: "Author Review & Sign-Off", body: "You receive a tracked changes file plus a clean copy. Accept, reject, or discuss any edit. Nothing is final until you approve it.", sample: [
      [
        { text: "Discussion", kind: "note" }, { text: " " }, ], [
        { text: "Conducting ", kind: "del" }, { text: "Doing", kind: "ins" }, { text: " an " }, { text: "extensively", kind: "del" }, { text: "extensive", kind: "ins" }, { text: " study of the shareholder activism undertaken by hedge funds in the Netherlands over " }, { text: "a for the", kind: "del" }, { text: "the", kind: "ins" }, { text: " past decade required a great deal of precise work. " }, { text: "But although ", kind: "del" }, { text: "Even though ", kind: "ins" }, { text: "I " }, { text: "didn't not", kind: "del" }, { text: "did not", kind: "ins" }, { text: " use any private information, this study " }, { text: "pretty nice gives a ", kind: "del" }, { text: "provides ", kind: "ins" }, { text: "insight into hedge fund activism in the country." }, ], ] as EditSegment[][], },
];

const METHODOLOGY_STEPS = [
  {
    icon: FaMagnifyingGlass, title: "Manuscript Review & Assessment", body: "You submit your manuscript draft. We assess your word count, genre, and editing needs to pair you with an editor specializing in your field.", }, {
    icon: FaClipboardList, title: "Project Guidelines & Style Setup", body: "We establish a customized editorial plan following Chicago Manual of Style (CMOS) guidelines, aligning with your publishing objectives.", }, {
    icon: FaLayerGroup, title: "Multi-Pass Editing", body: "Your editor conducts thorough passes refining story structure, tone, dialogue, line flow, grammar, and sentence clarity.", }, {
    icon: FaUserPen, title: "Editorial Review", body: "You receive two versions of your manuscript: a clean, publication-ready copy and a version showing all tracked changes and editorial notes.", },
];

const GENRES = [
  {
    id: "romance", label: "Romance", icon: FaHeart, title: "Romance", body: "Capture the emotions that keep readers turning pages. Our editors refine character development, dialogue, pacing, and emotional depth while preserving your unique voice. We help create compelling love stories that resonate with readers and leave a lasting impression.", covers: [
      { src: "/sp-editing-lp/romance-1.webp", alt: "Romance book cover sample" }, { src: "/sp-editing-lp/romance-2.webp", alt: "Romance book cover sample" }, ], }, {
    id: "science-fiction", label: "Science Fiction", icon: FaRocket, title: "Science Fiction", body: "Build immersive future worlds without sacrificing narrative momentum. Our editors carefully evaluate internal logic, technical consistency, sci-fi tropes, and plot pacing to ensure your high-concept ideas translate into a seamless, captivating read.", covers: [
      { src: "/sp-editing-lp/science-1.webp", alt: "Science Fiction book cover sample" }, { src: "/sp-editing-lp/science-2.webp", alt: "Science Fiction book cover sample" }, ], }, {
    id: "historical-fiction", label: "Historical Fiction", icon: FaLandmark, title: "Historical Fiction", body: "Transport readers to another era with accuracy and atmosphere. We refine dialogue authenticity, historical tone, and period-appropriate details while ensuring your central story and characters stay engaging and clear.", covers: [
      { src: "/sp-editing-lp/history-1.webp", alt: "Historical Fiction book cover sample" }, { src: "/sp-editing-lp/history-2.webp", alt: "Historical Fiction book cover sample" }, ], }, {
    id: "mystery-thriller", label: "Mystery/Thriller", icon: FaUserSecret, title: "Mystery/Thriller", body: "Keep your readers guessing until the very end. Our editing team meticulous checks plot continuity, red herrings, clue placement, suspense building, and pacing so your twists land with maximum impact.", covers: [
        { src: "/sp-editing-lp/thriller-1.webp", alt: "Mystery/Thriller book cover sample" }, { src: "/sp-editing-lp/thriller-2.webp", alt: "Mystery/Thriller book cover sample" }, ], }, {
    id: "self-help", label: "Self-Help", icon: FaLightbulb, title: "Self-Help", body: "Deliver your insights with maximum clarity and authority. We structure your actionable advice, organize chapter flow, eliminate redundancies, and refine your motivational tone so your wisdom inspires and impacts readers.", covers: [
      { src: "/sp-editing-lp/self-1.webp", alt: "Self-Help book cover sample" }, { src: "/sp-editing-lp/self-2.webp", alt: "Self-Help book cover sample" }, ], }, {
    id: "fantasy", label: "Fantasy", icon: FaHatWizard, title: "Fantasy", body: "Create a magical world readers will want to explore. Our editors refine world-building, character development, plot pacing, and thematic consistency while maintaining your unique voice and creative vision.", covers: [
      { src: "/sp-editing-lp/fant-1.webp", alt: "Fantasy book cover sample" }, { src: "/sp-editing-lp/fant-2.webp", alt: "Fantasy book cover sample" }, ], },
];

const TRUST_REASONS = [
  {
    number: "01", title: "100% Full Ownership", body: "You retain total copyright and ownership of your manuscript and all editorial revisions made.", }, {
    number: "02", title: "Transparent & Fair Pricing", body: "Premium editing services starting at just $0.03/word with no hidden fees or unexpected costs.", }, {
    number: "03", title: "Fast Turnaround Times", body: "Efficient, deadline-driven editing workflows that keep your publishing schedule on target.", }, {
    number: "04", title: "Dedicated Author Support", body: "Collaborative communication throughout the entire process, including direct feedback from your editor.", },
];

const TRUST_STATS = [
  { end: 900, suffix: "+", label: "Books Written" }, { end: 7, suffix: "+", label: "Year of Experience" }, { end: 50, suffix: "+", label: "Book Experts" }, { end: 100, suffix: "%", label: "Satisfaction Rate" },
];
...
const SOCIAL_LINKS = [
  { icon: FaFacebookF, label: "Facebook", href: "https://facebook.com" }, { icon: FaInstagram, label: "Instagram", href: "https://instagram.com" }, { icon: FaLinkedinIn, label: "LinkedIn", href: "https://linkedin.com" },
];
...
const PILL_FIELD =
  "w-full rounded-full px-5 py-3 text-sm font-medium text-[#111] outline-none transition-all duration-300 placeholder:text-[#111]/60 focus:ring-2 focus:ring-[#2D6A4F]/25 [&:-webkit-autofill]:[-webkit-text-fill-color:#111] [&:-webkit-autofill]:[box-shadow:0_0_0_1000px_#D8F3DC_inset]";

const PILL_SELECT = `${PILL_FIELD} form-select form-select-arrow-dark [&>option]:bg-white [&>option]:text-[#111]`;

function pillFieldStyle() {
  return { backgroundColor: PRIMARY_SOFT, color: ON_SOFT } as const;
}
  ...
  return (
    <form id={id} onSubmit={handleFormSubmit} className="w-full max-w-xl space-y-3">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        ...
        <button
          type="submit"
          className="w-full cursor-pointer rounded-full px-5 py-3 text-sm font-bold uppercase tracking-wide text-white transition-all duration-300 hover:-translate-y-0.5 hover:brightness-95 hover:shadow-lg active:scale-95"
          style={{ backgroundColor: PRIMARY }}
        >
          Submit Now
        </button>
      ...
      return (
        <span
          ...
          style={
            showEdits
              ? {
                  color: ON_PRIMARY, backgroundColor: PRIMARY, textDecorationColor: ON_PRIMARY, }
              : undefined
          }
        >
          {segment.text}
...
function TrackedEditingSample() {
  ...
  return (
    <div className="grid items-start gap-6 min-w-0 md:gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:gap-10">
            ...
            >
              <button
                ...
                className={`flex w-full items-center justify-between gap-3 px-4 py-3.5 text-left text-[13px] font-semibold transition-colors duration-300 cursor-pointer sm:gap-4 sm:px-5 sm:py-4 sm:text-sm ${
                  isOpen ? "text-white" : "text-[#111] hover:text-[#2D6A4F]"
                }`}
              ...
              >
                ...
                >
                  <FaChevronDown
                    className={`h-3 w-3 ${isOpen ? "text-white" : "text-[#2D6A4F]"}`}
                    aria-hidden="true"
                  />
                </motion.span>
              </button>
      ...
      >
        <p className="mb-4 text-xs font-semibold uppercase tracking-wide text-[#2D6A4F]">
          {stage.title}
        </p>
        ...
        <div className="mt-6 flex flex-col items-start gap-3 border-t border-black/10 pt-5 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
          ...
          >
            <span
              ...
              style={{ backgroundColor: showEdits ? PRIMARY : "#B7E4C7" }}
            >
              <motion.span
            ...
            <button
              ...
              className={`shrink-0 cursor-pointer rounded-full border px-4 py-2 text-xs font-semibold transition-all duration-300 sm:px-6 sm:py-2.5 sm:text-sm ${
                isActive
                  ...
                  : "border-[#D5D2DC] bg-white text-[#111] hover:border-[#2D6A4F]/30 hover:bg-[#F1FAF3]"
              }`}
            >
              {genre.label}
            </button>
...
function MidPageCta() {
  return (
    <section className="relative bg-[url('/sp-editing-lp/banner.webp')] bg-cover bg-center" aria-label="Special offer">
      <div className="absolute inset-0 bg-[#081C15]/90"></div>
        ...
        <div className="grid items-center gap-6 py-10 text-center md:py-12 lg:grid-cols-[1fr_auto_auto] lg:gap-10 lg:py-0 lg:text-left">
          <MotionColumn from="left" className="lg:py-10">
            ...
            <p className="mx-auto max-w-md text-[13px] leading-relaxed text-white/80 lg:mx-0">
              Partner with Aero Publishing's editorial team today. Get professional book editing tailored to your genre and save up to 50% on comprehensive manuscript packages.
            </p>
          </MotionColumn>
          ...
          <ScrollReveal variants={fadeIn} className="hidden lg:block">
            <img
              ...
              alt="Manuscript edited by Aero Publishing ready for publishing"
  ...
  return (
    <>
      ...
      <div className="overflow-x-clip">
        {/* Hero */}
        <section
          className="relative overflow-x-clip bg-[url('/sp-editing-lp/banner.webp')] bg-cover bg-center pt-24 pb-10 sm:pt-28 sm:pb-14 lg:pt-40 lg:pb-20"
          aria-labelledby="be-hero-heading"
        >
          <div className="absolute inset-0 bg-white/80"></div>
          <div
            className="pointer-events-none absolute -right-24 -top-24 z-0 h-[420px] w-[420px] rounded-full opacity-40"
            ...
            <div className="grid min-w-0 items-center gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
              ...
              >
                ...
                <motion.h1
                  id="be-hero-heading"
                  variants={staggerItem}
                  className="mb-4 max-w-full overflow-visible break-words font-sans text-[28px] font-bold leading-[1.2] text-[#111] sm:text-4xl"
                >
                  Book Editing and Proofreading That Keep Your Voice Intact
                </motion.h1>
                <motion.p
                  variants={staggerItem}
                  className="mb-6 max-w-xl text-sm leading-relaxed text-[#555] sm:text-[15px]"
                >
                  Aero Publishing editors transform your manuscript into a clean, captivating, publication ready book. From grammar, syntax, and punctuation to structure, plot pacing, and narrative tone, we meet industry publishing standards while preserving your authentic voice.
                </motion.p>
              ...
              <ScrollReveal variants={scaleIn} delay={0.15} className="min-w-0">
                <img
                  src="/sp-editing-lp/hero-img.webp"
                  alt="Aero Publishing book editing and proofreading services"
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 lg:gap-4">
              {METHODOLOGY_STEPS.map((step) => (
                ...
                >
                  ...
                  <p className="text-xs leading-relaxed text-[#40916C] sm:text-sm">{step.body}</p>
                </article>
              ))}
            </div>
          </div>
        ...
        <section className={SECTION_PADDING} aria-labelledby="be-genre-heading">
          <div className={CONTAINER}>
            <ScrollReveal className="mb-8 text-center">
              ...
              <p className={SECTION_SUBHEADING}>
                Choose your category and work with an editor who already knows its conventions, pacing, and readers.
              </p>
            </ScrollReveal>
            <GenreShowcase />
          </div>
          ...
          <div className={CONTAINER}>
            <ScrollReveal className="mb-10 text-center sm:mb-14">
              <h2 id="be-trust-heading" className={`${SECTION_HEADING} mx-auto max-w-xl`}>
                Why Authors Trust Aero Publishing for Book Editing
              </h2>
            </ScrollReveal>
                  ...
                  <div className="flex items-center gap-3 pt-1">
                    {SOCIAL_LINKS.map((social) => (
                      <a
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-full text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#081C15] hover:text-white"
                        style={{ backgroundColor: PRIMARY }}
                      >
