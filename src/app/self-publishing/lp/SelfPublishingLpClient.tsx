  ...
  <header className="hdr">
    <div className="shell hdr-in">
      <a className="logo" href="#top">
        ...
        <span className="logo-txt"><b>Aero Publishing</b><span>Self-Publishing</span></span>
      </a>
...
<section className="hero" id="top">
  ...
  <div className="shell hero-grid">
    <div>
      ...
      <p className="lede">
        Most self-publishing services stop at uploading your file to Amazon. Aero Publishing
      ...
      <table className="cmp">
        <thead>
          <tr>
            ...
            <th scope="col" className="hi">Aero Publishing</th>
          </tr>
        </thead>
        <tbody>
...
<footer className="ftr">
  <div className="shell ftr-grid">
    ...
    <div><h4>Services</h4><ul>
      ...
      <li><a href="/audio-book-narration">Audiobook</a></li>
    </ul></div>

    <div><h4>Company</h4><ul>
      <li><a href="/">Home</a></li>
      <li><a href="/about">About us</a></li>
      <li><a href="/children-book">Children's books</a></li>
      <li><a href="/authors-website">Author websites</a></li>
